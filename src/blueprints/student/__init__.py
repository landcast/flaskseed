...
def my_homework_sql(params):
    ...
    t.avatar as teacher_avatar,sc.teacher_evaluation,cs.name,sc.student_evaluation
    ...
    return ['id', 'question_name', 'homework_type', 'question_text', 'question_attachment_url',
            ...
            'teacher_name','course_name','teacher_avatar','teacher_evaluation','name','student_evaluation'], ''.join(sql)
