...
def my_homework_sql(params):
    ...
    if 'homework_state' in params.keys() \
        ...
        sql.append('  and and hm.homework_type = 1 and hm.id  not in ( select he1.homework_id from homework he1,study_schedule sc1 '
    ...
    return ['id', 'question_name', 'homework_type', 'question_text', 'question_attachment_url',
            ...
            'teacher_name','course_name','teacher_avatar','teacher_evaluation','name','student_evaluation','evaluation','name'], ''.join(sql)
