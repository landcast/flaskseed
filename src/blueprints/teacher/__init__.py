...
def apply_students_sql(params):
    ...
    sql = ['''
          ...
          (select count(*) from study_appointment sa1,course_appointment ca1 where sa1.id = ca1.study_appointment_id and sa1.`student_id` = s.id and ca1.appointment_state = 'ACCEPT' and ca1.study_appointment_id = sa.id) apply_state
