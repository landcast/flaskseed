...
class StudySchedule(EntityMixin, db.Model):
    ...
    student_evaluation = Column(String(5000), nullable=True, comment='学生评价')
    student_result = Column(String(5000), nullable=True, comment='学生结果反馈')
    teacher_evaluation = Column(String(5000), nullable=True, comment='教师评价')
    teacher_result = Column(String(5000), nullable=True, comment='教师结果反馈')
    homework = Column(String(255), nullable=True, comment='作业')
    test = Column(String(5000), nullable=True, comment='课后测试')
